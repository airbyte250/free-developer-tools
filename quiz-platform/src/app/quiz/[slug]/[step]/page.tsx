...
export default async function QuizStepPage({ params }: { params: Promise<{ slug: string; step: string }> }) {
  ...
  const initialStep = step === 'result' ? -1 : parseInt(step, 10) || 1

  return <QuizEngine tenantPayload={tenantPayload} initialStep={initialStep} />
}
