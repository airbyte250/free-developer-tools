  ...
  Future<void> _checkRoute(LatLng origin, LatLng destination, int routeIndex) async {
    try {
      ...
      for (final leg in legs) {
        ...
        // Use full address instead of just first part
        ...
        if (severity != null) {
          ...
          // Hindi voice alert with full address
          await _notificationService.speakAlert(
            '$_areaName में ट्रैफिक जाम लगा है। '
            '$locationName पर $trafficPercent प्रतिशत ज्यादा भीड़ है।',
          );
          ...
          if (_activeJams.containsKey(routeIndex)) {
            ...
            // Hindi voice for resolved
            await _notificationService.speakAlert(
              '$_areaName में ट्रैफिक अब सामान्य हो गया है। '
              '$durationMinutes मिनट तक जाम था।',
            );
          }
        }
      }
